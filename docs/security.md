...
Each cycle runs on a **fresh disk clone, destroyed on teardown** — an APFS
`clonefile(2)` clone on darwin, a VHDX differencing disk on windows — by the
destroy-and-recycle mechanism
